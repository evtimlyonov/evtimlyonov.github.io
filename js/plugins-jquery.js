  ...
  function o(t) {
    e.requestAnimationFrame(function () {
      ...
      for (var e = 0, i = h.length; e < i; e++)
        'scroll' !== t.type && (h[e].coverImage(), h[e].clipContainer()),
          h[e].onScroll();
    });
  }
  Date.now ||
  ...
  (y.prototype.css = function (t, n) {
    ...
    (y.prototype.init = function () {
      ...
      for (var o = 0, a = t.$item; null !== a && a !== document && 0 === o; ) {
        var r =
          t.css(a, '-webkit-transform') ||
          t.css(a, '-moz-transform') ||
          t.css(a, 'transform');
        r &&
          'none' !== r &&
          ((o = 1),
      ...
      if (t.image.width && t.image.height) {
        ...
        if (
          ...
          (t.isElementInViewport =
            s.bottom >= 0 && s.right >= 0 && s.top <= r && s.left <= a),
...
!(function () {
  ...
  function t() {
    if (!X && document.body) {
      ...
      var t = document.body,
        ...
        r = t.scrollHeight;
      if (
        ((Y = document.compatMode.indexOf('CSS') >= 0 ? o : t),
        (k = t),
        e(),
        top != self)
      )
        ...
        (M = function () {
          i ||
            (i = setTimeout(function () {
              L ||
                ((a.style.height = '0'),
                (a.style.height = Y.scrollHeight + 'px'),
                (i = null));
            }, 500));
        }),
          setTimeout(M, 10),
        ...
        i = function (n) {
          ...
          if (a) {
            ...
            document.createEvent
              ? (p = document.createEvent('HTMLEvents')).initEvent(
                  'smoothScrollCustomEvent',
                  !0,
                  !0
                )
              : ((p = document.createEventObject()).eventType =
                  'smoothScrollCustomEvent'),
              (p.eventName = 'smoothScrollCustomEvent'),
              document.createEvent
                ? window.dispatchEvent(p)
                : window.fireEvent('on' + p.eventType, p);
          } else l && (e.scrollLeft += l), c && (e.scrollTop += c);
          t || o || (P = []),
            P.length ? _(i, e, 1e3 / z.frameRate + 1) : (R = !1);
        };
      _(i, e, 0), (R = !0);
    }
  }
  ...
  'onwheel' in document.createElement('div')
    ...
    I &&
      oe &&
      ((window.isSmoothScroll = !0), f(I, r), f('mousedown', i), f('load', t)),
    (E.destroy = o),
    window.SmoothScrollOptions && E(window.SmoothScrollOptions),
    'function' == typeof define && define.amd
      ? define(function () {
          return E;
        })
